...
<head>
    ...
    <link href="<?php echo base_url('assets/backend/'); ?>css/sb-admin-2.css" rel="stylesheet">
    <link href="<?php echo base_url('AVUKAT/assets/backend/upload'); ?>otkhukuk.png" rel="stylesheet">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="<?php echo base_url('Admin/loginislem'); ?>" method="post">
