  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Partnerler Kart Ekleme Sayfası</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div style="margin-left:50px; margin-right:50px;"  class="panel-body">
      <form action="<?php echo base_url('admin/partnerlerkartekle'); ?>" role="form" method="POST" enctype= "multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input name="k_facebook" class="form-control" type="text" >
          <p class="help-block"></p>
        </div>

        <div class="form-group">
          <label>Twitter Adresi Giriniz</label>
          <input name="k_twitter" class="form-control" type="text" >
          <p class="help-block"></p>
        </div>

        <div class="form-group">
          <label>İnstagram Adresi Giriniz</label>
          <input name="k_instagram" class="form-control" type="text" >
          <p class="help-block"></p>
        </div>
        <div class="form-group">
          <label>Linkedin Adresi Giriniz</label>
          <input name="k_linkedin" class="form-control" type="text" >
          <p class="help-block"></p>
        </div>
