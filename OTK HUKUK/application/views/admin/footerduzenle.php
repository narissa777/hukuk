    ...
    <div style="margin-left:50px; margin-right:50px;"  class="panel-body">
      <form action="<?php echo base_url('admin/footerduzenle'); ?>" role="form" method="POST" enctype= "multipart/form-data">
        ...
        <div class="form-group">
          <label>Footer Başlık Düzenle</label>
          <input name="baslik" class="form-control" type="text" value="<?php echo $footer[0]->baslik ; ?>">
          <p class="help-block">Başlık ekleyiniz.</p>
        </div>
        <div class="form-group">
          <label>Footer Açıklama Düzenle</label>
          <input name="aciklama" class="form-control" type="text" value="<?php echo $footer[0]->aciklama; ?>">
