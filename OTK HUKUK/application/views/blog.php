     ...
     <div class="row">
      <div class="col-xl-12">
       <div class="bradcam_text text-center">
        <h3><?php echo $faaliyet[0]->kartbaslik; ?> </h3>
         ...
         <div class="col-lg-8 posts-list">
            <div class="single-post">
               <div class="feature-img">
                  <img class="img-fluid" src="<?php echo base_url('').$faaliyet[0]->f_blogresim; ?>" alt="">
               </div>
               <div class="blog_details">
                  <h2><?php echo $faaliyet[0]->f_blogbaslik; ?>
               </h2>
               
               
               <?php echo $faaliyet[0]->f_blogaciklama; ?>
